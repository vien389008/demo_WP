...
function modern_ecommerce_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new Modern_Ecommerce_Toggle_Control( $wp_customize, 'modern_ecommerce_slider_arrows', array(
		'label'       => esc_html__( 'Check to show slider', 'modern-ecommerce' ),
